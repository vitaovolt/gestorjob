...
**Objetivo:** 1 fluxo E2E completo (API + página React + Playwright).

## Arquivos

- endpoints + pages + services do slice
- `code/frontend/e2e/` (Playwright)
...
- [ ] Feature do slice afirma efeito (DB / fake), não só HTTP 200
- [ ] Listagens do slice com `with()` se houver relação
- [ ] UX do slice: CTA verbo, um primário, toast/banner no topo, submit com “Processando…” — `standards/UX-PROTOTIPO.md`
