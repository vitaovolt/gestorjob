...
export function AuthProvider({ children }) {
  ...
  async function logout() {
    ...
    try {
      ...
      // Não apagar sessão nova (ex.: aceitar convite) se o logout atrasou.
  ...
  return (
    <AuthContext.Provider value={{ user, loading, login, logout, aplicarSessao, atualizarUsuario, isAuthenticated: Boolean(user) }}>
      {children}
